...
## 역할[](https://beomy.github.io/tech/react/tanstack-query-v4/#%EC%97%AD%ED%95%A0)
...
## 쿽 스타트[](https://beomy.github.io/tech/react/tanstack-query-v4/#%EC%BF%BD-%EC%8A%A4%ED%83%80%ED%8A%B8)
...
## 기본 개념[](https://beomy.github.io/tech/react/tanstack-query-v4/#%EA%B8%B0%EB%B3%B8-%EA%B0%9C%EB%85%90)

React Query를 사용할 때 자주 접하게 되는 React Query의 중요한 개념들과 설정들을 살펴보도록 하겠습니다.

### Query와 Mutation[](https://beomy.github.io/tech/react/tanstack-query-v4/#query%EC%99%80-mutation)
...
### 다시 가져오기[](https://beomy.github.io/tech/react/tanstack-query-v4/#%EB%8B%A4%EC%8B%9C-%EA%B0%80%EC%A0%B8%EC%98%A4%EA%B8%B0)
...
### `retry`[](https://beomy.github.io/tech/react/tanstack-query-v4/#retry)
...
### `staleTime`[](https://beomy.github.io/tech/react/tanstack-query-v4/#staletime)
...
### `cacheTime`[](https://beomy.github.io/tech/react/tanstack-query-v4/#cachetime)
...
### `queryKey`[](https://beomy.github.io/tech/react/tanstack-query-v4/#querykey)
...
#### `queryKey` 배열 순서[](https://beomy.github.io/tech/react/tanstack-query-v4/#querykey-%EB%B0%B0%EC%97%B4-%EC%88%9C%EC%84%9C)
...
### `queryFn`와 `mutationFn`[](https://beomy.github.io/tech/react/tanstack-query-v4/#queryfn%EC%99%80-mutationfn)
...
#### 에러 처리 방법[](https://beomy.github.io/tech/react/tanstack-query-v4/#%EC%97%90%EB%9F%AC-%EC%B2%98%EB%A6%AC-%EB%B0%A9%EB%B2%95)

`queryFn`, `mutationFn`에서 에러가 발행하면 `Promise.reject(new Error(message))` 혹은 `trow new Error(message)`로 에러를 처리해 줘야 합니다.

#### `QueryFunctionContext`[](https://beomy.github.io/tech/react/tanstack-query-v4/#queryfunctioncontext)
...
## 캐싱 라이프 사이클[](https://beomy.github.io/tech/react/tanstack-query-v4/#%EC%BA%90%EC%8B%B1-%EB%9D%BC%EC%9D%B4%ED%94%84-%EC%82%AC%EC%9D%B4%ED%81%B4)
...
## 기본 값 설정[](https://beomy.github.io/tech/react/tanstack-query-v4/#%EA%B8%B0%EB%B3%B8-%EA%B0%92-%EC%84%A4%EC%A0%95)
...
## 유용한 기능들[](https://beomy.github.io/tech/react/tanstack-query-v4/#%EC%9C%A0%EC%9A%A9%ED%95%9C-%EA%B8%B0%EB%8A%A5%EB%93%A4)
...
### `useQuery`[](https://beomy.github.io/tech/react/tanstack-query-v4/#usequery)
...
#### `select` 옵션[](https://beomy.github.io/tech/react/tanstack-query-v4/#select-%EC%98%B5%EC%85%98)
...
#### `enabled` 옵션[](https://beomy.github.io/tech/react/tanstack-query-v4/#enabled-%EC%98%B5%EC%85%98)
...
#### `keepPreviousData` 옵션[](https://beomy.github.io/tech/react/tanstack-query-v4/#keeppreviousdata-%EC%98%B5%EC%85%98)
...
|:-:|:-:|
|![keyPreviousData: true](https://beomy.github.io/assets/img/posts/react/react_query_keep_previous_data_true.gif)|![keyPreviousData: false](https://beomy.github.io/assets/img/posts/react/react_query_keep_previous_data_false.gif)|

#### `refetch` 반환[](https://beomy.github.io/tech/react/tanstack-query-v4/#refetch-%EB%B0%98%ED%99%98)
...
#### `stauts` 반환[](https://beomy.github.io/tech/react/tanstack-query-v4/#stauts-%EB%B0%98%ED%99%98)
...
### `useMutation`[](https://beomy.github.io/tech/react/tanstack-query-v4/#usemutation)
...
### `useQueries`[](https://beomy.github.io/tech/react/tanstack-query-v4/#usequeries)

병렬 쿼리란 동시에 여러 쿼리를 요청하는 방법입니다. 정적으로 정해진 쿼리들을 요청하는 Manual 방법과 동적으로 결정되는 쿼리를 요청하는 Dynamic 방법 2가지 방법을 살펴보도록 하겠습니다.

#### Manual Parallel Queries[](https://beomy.github.io/tech/react/tanstack-query-v4/#manual-parallel-queries)
...
#### Dynamic Parallel Queries[](https://beomy.github.io/tech/react/tanstack-query-v4/#dynamic-parallel-queries)
...
### `useInfiniteQuery`[](https://beomy.github.io/tech/react/tanstack-query-v4/#useinfinitequery)
...
#### `data`[](https://beomy.github.io/tech/react/tanstack-query-v4/#data)
...
#### `refetch`[](https://beomy.github.io/tech/react/tanstack-query-v4/#refetch)
...
#### `fetchNextPage`, `fetchPreviousPage`[](https://beomy.github.io/tech/react/tanstack-query-v4/#fetchnextpage-fetchpreviouspage)
...
#### `getNextPageParam`, `getPreviousPageParam`[](https://beomy.github.io/tech/react/tanstack-query-v4/#getnextpageparam-getpreviouspageparam)
...
#### `hasNextPage`, `hasPreviousPage`[](https://beomy.github.io/tech/react/tanstack-query-v4/#hasnextpage-haspreviouspage)
...
#### `isFetchingNextPage`, `isFetchingPreviousPage`[](https://beomy.github.io/tech/react/tanstack-query-v4/#isfetchingnextpage-isfetchingpreviouspage)
...
### `useIsFetching`[](https://beomy.github.io/tech/react/tanstack-query-v4/#useisfetching)
...
### `useIsMutating`[](https://beomy.github.io/tech/react/tanstack-query-v4/#useismutating)
...
### `QueryClient`[](https://beomy.github.io/tech/react/tanstack-query-v4/#queryclient)
...
#### 쿼리 무효화[](https://beomy.github.io/tech/react/tanstack-query-v4/#%EC%BF%BC%EB%A6%AC-%EB%AC%B4%ED%9A%A8%ED%99%94)
...
#### 쿼리 취소[](https://beomy.github.io/tech/react/tanstack-query-v4/#%EC%BF%BC%EB%A6%AC-%EC%B7%A8%EC%86%8C)
...
> ##### `fetch`, `axios` v0.22.0 아래의 버전, `XMLHttpRequest`, `graphql-request`에서 쿼리 취소[](https://beomy.github.io/tech/react/tanstack-query-v4/#fetch-axios-v0220-%EC%95%84%EB%9E%98%EC%9D%98-%EB%B2%84%EC%A0%84-xmlhttprequest-graphql-request%EC%97%90%EC%84%9C-%EC%BF%BC%EB%A6%AC-%EC%B7%A8%EC%86%8C)
> 
...
#### 쿼리 업데이트[](https://beomy.github.io/tech/react/tanstack-query-v4/#%EC%BF%BC%EB%A6%AC-%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8)
...
#### 쿼리 미리 가져오기[](https://beomy.github.io/tech/react/tanstack-query-v4/#%EC%BF%BC%EB%A6%AC-%EB%AF%B8%EB%A6%AC-%EA%B0%80%EC%A0%B8%EC%98%A4%EA%B8%B0)
...
## 부록[](https://beomy.github.io/tech/react/tanstack-query-v4/#%EB%B6%80%EB%A1%9D)

### ErrorBoundary[](https://beomy.github.io/tech/react/tanstack-query-v4/#errorboundary)
...
### Suspense[](https://beomy.github.io/tech/react/tanstack-query-v4/#suspense)
...
### DevTools[](https://beomy.github.io/tech/react/tanstack-query-v4/#devtools)
...
### ESLint[](https://beomy.github.io/tech/react/tanstack-query-v4/#eslint)
...
#### `@tanstack/query/exhaustive-deps`[](https://beomy.github.io/tech/react/tanstack-query-v4/#tanstackqueryexhaustive-deps)
...
#### `@tanstack/query/prefer-query-object-syntax`[](https://beomy.github.io/tech/react/tanstack-query-v4/#tanstackqueryprefer-query-object-syntax)
...
##### 참고[](https://beomy.github.io/tech/react/tanstack-query-v4/#%EC%B0%B8%EA%B3%A0)
